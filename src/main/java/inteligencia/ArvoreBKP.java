...
public class ArvoreBKP {
	...
	if (no.altura >= 2) { // critério de parada da recursividade
	    no.valor = Integer.parseInt(JOptionPane.showInputDialog("Digite uma nota para o nó: "));
		...
		aux = geraArvore(novoFilho); // chamada recursiva
